...
[![Azure VMware Solution Deployment](https://github.com/tredavismicrosoft/documentation/blob/master/deploy2.png)](https://youtu.be/1JLB3L2WDWI "Azure VMware Solution Deployment")
